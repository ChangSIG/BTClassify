...
def parse_args():
    ...
    parser.add_argument('--img',
                        # default='datas/LW/test/009-2_m.jpg',
                        # default='datas/LW/train/009-1_m.jpg',
                        default='datas/LW/train/014-1_m.jpg',
                        help='Image file')
    parser.add_argument('--config',
                        # default='logs/HRNet/2023-04-28-16-24-57/hrnet-w64.py',
                        # default='logs/HRNetCBAM/2023-04-28-15-52-10/hrnet-w64-cbam.py',
                        # default='logs/HRNetCS/2023-04-28-16-48-09/hrnet-w64-cs.py',
                        # default='logs/GNN/2023-04-29-00-32-21/gnn-big.py',
    ...
    parser.add_argument(
        '--save-path',
        # default='logs/HRNet/2023-04-28-16-24-57/predict/009-1_m_cam.jpg',
        # default='logs/HRNetCBAM/2023-04-28-15-52-10/predict/009-1_m_cam.jpg',
        # default='logs/HRNetCS/2023-04-28-16-48-09/predict/009-2_m_cam.jpg',
        default='logs/GNN/2023-04-29-00-32-21/predict/009-1_m_cam_3.jpg',
        type=Path,
...
def get_default_traget_layers(model, args):
    ...
    target_layers = [norm_layers[-1]]   # HRNet\HRNet-CBAM\GCN
    # target_layers = [norm_layers[-2]] #HRNet-CS
